...
interface props{
    ...
    opened:boolean
    setSelectedLocalFolder:typeof useState
}  

const LocalFiles = ({tree,setSelectedLocalFolder}:props)=>{ 
        ...
        <div className="border rounded-lg  h-96">
            ...
            <div>
               ...
               <div className=" flex ">
                ...
                >make</button></div>
               :<div></div>}
                <DisplayLocal opened={true} tree={tree} setSelectedLocalFolder={setSelectedLocalFolder}></DisplayLocal>
            </div>}
          </div>
    )
}
...
function DisplayLocal({opened,tree,setSelectedLocalFolder}:props){
                ...
                {childrenList.map(child=>{
                    ...
                    <div key={child.path}>
                        ...
                        <div className="pl-6 flex flex-col py-1">
                            ...
                            :<div></div>}
                            <div>
                                <DisplayLocal opened={opened} tree={child} setSelectedLocalFolder={setSelectedLocalFolder}></DisplayLocal>
                            </div>
                        </div>
                        :
                        // it is files
