  ...
  return (
    <>
      <button
        ...
        className={` flex flex-row items-center px-2 hover:bg-blue-200 dark:hover:bg-gray-700 w-full ${
      ...
      >
        ...
        >
          <div className="flex flex-col">
            {duplicate && (
              <button
                className="hover:bg-gray-200 dark:hover:bg-gray-500 rounded  px-2 text-left whitespace-nowrap"
                onClick={() => _duplicate()}
              >
                duplicate
              </button>
      ...
      >
        <Dialog
          ...
          className={`absolute shadow-lg top-1/2 left-1/2 rounded-lg -translate-x-1/2 -translate-y-1/2 z-30 inset-0 overflow-y-auto bg-white w-fit h-fit dark:bg-gray-600 `}
        >
          <div className="p-3 z-10">
            <p>folder name :</p>
            <input
              className="outline-none px-2 bg-white border border-gray-400 rounded mr-3 w-96 dark:bg-gray-700 dark:text-white text-gray-600"
      ...
      >
        <Dialog
          ...
          className={`absolute shadow-lg top-1/2 left-1/2 rounded-lg -translate-x-1/2 -translate-y-1/2 z-30 inset-0 overflow-y-auto bg-white dark:bg-gray-600 w-fit h-fit`}
        >
          <div className="p-3 z-10">
            <p>new file name :</p>
            <input
              className="outline-none px-2 bg-white dark:bg-gray-700 border border-gray-400 rounded mr-3 w-96 text-gray-600 dark:text-white"
              ref={fileNameInputRef}
              defaultValue={path.basename(data?.fileName as string)}
            />
            <button
              className="bg-green-400 text-white px-2 rounded"
              onClick={() => {
      ...
      >
        <Dialog
          ...
          className={
            "absolute shadow-lg top-1/2 left-1/2 rounded-lg -translate-x-1/2 -translate-y-1/2 z-30 inset-0 overflow-y-auto bg-white w-fit h-fit dark:bg-gray-700"
          }
        >
          <div className="p-3 z-10">
            <p className="font-bold text-lg text-gray-700 dark:text-gray-300">
              Info of <span className="underline">{data?.fileName}</span>
            </p>
