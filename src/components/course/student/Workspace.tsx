      ...
      <div className="flex flex-row space-x-4 items-start">
        <div className="w-1/12 mt-4">
          <span className="relative flex h-3 w-3">
            ...
            <span
              className={`${baseClass} ${flag ? activeClass : inactiveClass}`}
            ></span>
          </span>
        </div>
        <div className="w-full">
          ...
          <div>
            <a
              href={template.imageId}
              target="_blank"
              rel="noreferrer"
              className="font-medium text-xs text-gray-600 underline dark:text-gray-300"
            >
              {template.imageId}
            </a>
          </div>
