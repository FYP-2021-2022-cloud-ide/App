...
interface CnailsContextState {
    ...
    downloadFileToUser: (userId: string, filePath: string, isFolder: boolean) => Promise<any>,
    downloadFileToNext: (userId: string, filePath: string) => Promise<any>,
    uploadFiles: (userId: string, content: FormData, updateProgress?: (progress: number) => void) => Promise<any>,
...
export const CnailsProvider = ({ children }: CnailsProviderProps) => {
    ...
    const downloadFileToUser = async (userId: string, filePath: string, isFolder: boolean) => {
    ...
    const uploadFiles = async (userId: string, content: FormData, update?: (progress: number) => void) => {
