          ...
          <Tab
            className={({ selected }) =>
              classNames(
                ...
                selected
                  ? "bg-white text-blue-700 dark:text-white dark:bg-slate-900 shadow"
                  : "text-white dark:text-gray-300 hover:bg-white/[0.12] dark:hover:bg-white/[0.05] hover:text-white"
              )
            }
          >
            Courses
