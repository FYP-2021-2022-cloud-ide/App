...
export class FileChunk extends jspb.Message { 
    ...
    getTotalsize(): string;
    setTotalsize(value: string): FileChunk;
    getTransferred(): string;
    setTransferred(value: string): FileChunk;
...
export class DownloadReuqest extends jspb.Message { 
    getFilepath(): string;
    setFilepath(value: string): DownloadReuqest;
    getUserid(): string;
    setUserid(value: string): DownloadReuqest;

    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): DownloadReuqest.AsObject;
    static toObject(includeInstance: boolean, msg: DownloadReuqest): DownloadReuqest.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: DownloadReuqest, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): DownloadReuqest;
    static deserializeBinaryFromReader(message: DownloadReuqest, reader: jspb.BinaryReader): DownloadReuqest;
}

export namespace DownloadReuqest {
    export type AsObject = {
        filepath: string,
        userid: string,
    }
...
export class DownloadReply extends jspb.Message { 
    ...
    setFilechunk(value?: FileChunk): DownloadReply;
