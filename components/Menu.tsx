...
const Menu = ({sub, name, email}:props) => {
    return (
        <div className="grid grid-cols-3 gap-8 w-full">
            <div></div>
            <div className="border flex text-gray-500 flex-row space-x-2 items-center focus:border-black-600 text-left rounded-xl hover:border-blue-600 w-96 px-2 shadow">
